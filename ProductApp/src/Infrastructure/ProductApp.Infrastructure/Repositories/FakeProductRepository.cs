...
namespace ProductApp.Infrastructure.Repositories
{
    public class FakeProductRepository : IProductRepository
    {
        ...
        public FakeProductRepository()
        {
            _products = new()
            {
                new Product{Id=1, Name="Casper", Description="Excalibur G870.1245-DXA0X-B Intel Core i5-12450H 32GB RAM 2TB NVME SSD 6GB RTX4050", Price=25.499, 
                ...
                new Product{Id=2, Name="Lenovo", Description="Ideapad1/Celeron N4120/4GB Ram/128GB emmc /15.6\"/Win 11 82V7005MTX", Price=5.899,
                ...
                new Product{Id=4, Name="Apple", Description="iPad 9. Nesil 64 GB 10.2\" Wi-Fi Gümüş Tablet (Apple Türkiye Garantili) 10.2 inç RAM : 3 Gb ", Price=7.899 , 
                ...
                new Product{Id=5, Name="XİAOMİ", Description="X4 Pro 5G 6GB Ram 128GB Hafıza Type-C Şarj Girişli Mavi (POCO Türkiye Garantili)", Price=7.999 ,
                ...
                new Product{Id=6, Name="Apple", Description="Macbook Air 13'' M1 8gb 256gb Ssd Uzay Grisi Dizüstü Bilgisayar MGND3TU/A", Price=20.799,
                ...
                new Product{Id=7, Name="Lenovo", Description="Tab M10 TB-X306F 4GB + 64GB 10.1\" Wi-Fi Gri Tablet - ZA6W0121TR (Türkiye Garantili)", Price=3.999,
                ...
                new Product{Id=8, Name="Samsung", Description="Galaxy A32 6 Gb Ram ,128 GB Hafıza Kamera : 60-80 Mp  Siyah Cep Telefonu (Türkiye Garantili)", Price=7.398 ,
                ...
                new Product{Id=9, Name="Xiaomi", Description="X4 Pro 5G 8 GB+256 GB Sarı Cep Telefonu (Xiaomi Türkiye Garantili)", Price=8.999 ,
                ...
                new Product{Id=10, Name="Lenovo", Description="Tab M10 Plus TB-X606F 4GB + 128GB 10.3\" Wi-Fi Gri Tablet - ZA6H0025TR (Türkiye Garantili)", Price=5.199 ,
                ...
                new Product{Id=11, Name="Asus", Description="X415ma-ek385w/cel N4020/4gb Ram/128gb Ssd/14\"/wın11 Convertible Laptop Gri", Price=5.249,
                ...
                new Product{Id=12, Name="Hometech", Description="Alfa-10tb 4 Gb Ram 64gb Hafıza 10 inç Ips Tablet + Klavye + Kılıf 227", Price=2.959,
                ...
                new Product{Id=13, Name="Apple", Description="iPad Mini 6. Nesil 64 GB 8.3\" Wi-Fi Uzay Grisi Tablet (Apple Türkiye Garantili) MK7P3TU/A", Price=13.199 ,
                ...
                new Product{Id=14, Name="Acer", Description="Nitro 5 Intel Core i5-12500H 8GB 512GB SSD 4GB RTX3050Ti Linux 15.6'' FHD Gaming Laptop", Price=17.498 ,
                ...
                new Product{Id=16, Name="Alcatel", Description="Alcatel 1t 10 2020 Wifi Bluetooth Klavyeli Kılıf Tablet 16 Gb Hafıza 1 Gb Ram Kamera : 5 Mp, Siyah", Price=1.659,
                ...
                new Product{Id=17, Name="Casper", Description="Nirvana C370.4020-4C00B Intel Celeron N4020 4GB/120GB SSD Windows 11 Home 15.6\" HD", Price=5.399 ,
                ...
                new Product{Id=18, Name="Reeder", Description="Reeder S19 Max 4 Gb Ram 32 Gb Hafıza Usb Type-C Şarj Girişli 3500-4000mAH Batarya, Yeşil", Price=2.259 ,
                ...
                new Product{Id=19, Name="Huawei", Description="Matebook D15/ I5-1155g7 Işlemci 8gb/256gb 15.6 Inç/ Win 11 Laptop Mistik Gümüş ", Price=11.155 ,
                ...
                new Product{Id=20, Name="MSI", Description="MSI TITAN GT77 12UHS-036TR I9-12900HXRTX3080TI GDDR6 16Gb/2TB 17.3 UHD 120Hz W11", Price=164.999,
                ...
                new Product{Id=22, Name="Vorcom", Description="Vorcom 10.1 Inc 4 Gb Ram 64 Gb Hafıza 1280*800 Ips 8 Çekirdek Işlemcili  Mavi Tablet QuartzLITE", Price=2.299 ,
                ...
                new Product{Id=23, Name="Apple", Description="Apple iPhone 13 128 GB Yıldız Işığı Cep Telefonu (Apple Türkiye Garantili)", Price=28.498 ,
