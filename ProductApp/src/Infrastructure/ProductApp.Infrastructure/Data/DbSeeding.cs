...
namespace ProductApp.Infrastructure.Data
{
    ...
    {
        public static void SeedDatabase(ProductDbContext dbContext)
        {
        ...
        private static void seedCourseIfNotExist(ProductDbContext dbContext)
        {
            if (!dbContext.Products.Any())
            {
                ...
                {
                    new Product{Name="Casper", Description="Excalibur G870.1245-DXA0X-B Intel Core i5-12450H 32GB RAM 2TB NVME SSD 6GB RTX4050", Price=25499,
                    ...
                    new Product{Name="Lenovo", Description="Ideapad1/Celeron N4120/4GB Ram/128GB emmc /15.6\"/Win 11 82V7005MTX", Price=5899,
                    ...
                    new Product{Name="Xiaomi", Description="Redmi Note 12 Pro 8gb/256gb Gri 6.7 inç Kamera : 100-120 MP ( Xiaomi Türkiye Garantili)", Price=9799 ,
                    ...
                    new Product{Name="Apple", Description="iPad 9. Nesil 64 GB 10.2\" Wi-Fi Gümüş Tablet (Apple Türkiye Garantili) 10.2 inç RAM : 3 Gb ", Price=7899 ,
                    ...
                    new Product{Name="XİAOMİ", Description="X4 Pro 5G 6GB Ram 128GB Hafıza Type-C Şarj Girişli Mavi (POCO Türkiye Garantili)", Price=7999 ,
                    ...
                    new Product{Name="Apple", Description="Macbook Air 13'' M1 8gb 256gb Ssd Uzay Grisi Dizüstü Bilgisayar MGND3TU/A", Price=20799,
                    ...
                    new Product{Name="Lenovo", Description="Tab M10 TB-X306F 4GB + 64GB 10.1\" Wi-Fi Gri Tablet - ZA6W0121TR (Türkiye Garantili)", Price=3999,
                    ...
                    new Product{Name="Samsung", Description="Galaxy A32 6 Gb Ram ,128 GB Hafıza Kamera : 60-80 Mp  Siyah Cep Telefonu (Türkiye Garantili)", Price=7398 ,
                    ...
                    new Product{Name="Xiaomi", Description="X4 Pro 5G 8 GB+256 GB Sarı Cep Telefonu (Xiaomi Türkiye Garantili)", Price=8999 ,
                    ...
                    new Product{Name="Lenovo", Description="Tab M10 Plus TB-X606F 4GB + 128GB 10.3\" Wi-Fi Gri Tablet - ZA6H0025TR (Türkiye Garantili)", Price=5199 ,
                    ...
                    new Product{Name="Asus", Description="X415ma-ek385w/cel N4020/4gb Ram/128gb Ssd/14\"/wın11 Convertible Laptop Gri", Price=5249,
                    ...
                    new Product{Name="Hometech", Description="Alfa-10tb 4 Gb Ram 64gb Hafıza 10 inç Ips Tablet + Klavye + Kılıf 227", Price=2959,
                    ...
                    new Product{Name="Apple", Description="iPad Mini 6. Nesil 64 GB 8.3\" Wi-Fi Uzay Grisi Tablet (Apple Türkiye Garantili) MK7P3TU/A", Price=13199 ,
                    ...
                    new Product{Name="Acer", Description="Nitro 5 Intel Core i5-12500H 8GB 512GB SSD 4GB RTX3050Ti Linux 15.6'' FHD Gaming Laptop", Price=17498 ,
                    ...
                    new Product{Name="Samsung", Description="Sinada Samsung E1205 Siyah Kamerasız Cep Telefonu (RESMİ BTK KAYITLI) E1205yeni", Price=769 ,
                    ...
                    new Product{Name="Alcatel", Description="Alcatel 1t 10 2020 Wifi Bluetooth Klavyeli Kılıf Tablet 16 Gb Hafıza 1 Gb Ram Kamera : 5 Mp, Siyah", Price=1659,
                    ...
                    new Product{Name="Casper", Description="Nirvana C370.4020-4C00B Intel Celeron N4020 4GB/120GB SSD Windows 11 Home 15.6\" HD", Price=5399 ,
                    ...
                    new Product{Name="Reeder", Description="Reeder S19 Max 4 Gb Ram 32 Gb Hafıza Usb Type-C Şarj Girişli 3500-4000mAH Batarya, Yeşil", Price=2259 ,
                    ...
                    new Product{Name="Huawei", Description="Matebook D15/ I5-1155g7 Işlemci 8gb/256gb 15.6 Inç/ Win 11 Laptop Mistik Gümüş ", Price=11155 ,
                    ...
                    new Product{Name="MSI", Description="MSI TITAN GT77 12UHS-036TR I9-12900HXRTX3080TI GDDR6 16Gb/2TB 17.3 UHD 120Hz W11", Price=164999,
                    ...
                    new Product{Name="Nokia", Description="SenalStore Nokia 1200 1500mAH Batarya, Ön Kamera : 1 Mp, Kamera Çözünürlüğü : 5 Mp", Price=455,
                    ...
                    new Product{Name="Vorcom", Description="Vorcom 10.1 Inc 4 Gb Ram 64 Gb Hafıza 1280*800 Ips 8 Çekirdek Işlemcili  Mavi Tablet QuartzLITE", Price=2299 ,
                    ...
                    new Product{Name="Apple", Description="Apple iPhone 13 128 GB Yıldız Işığı Cep Telefonu (Apple Türkiye Garantili)", Price=28498 ,
                ...
                dbContext.Products.AddRange(courses);
                dbContext.SaveChanges();
            }
        }
    }
